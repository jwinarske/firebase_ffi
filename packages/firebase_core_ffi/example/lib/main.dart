...
// Initializes Firebase and shows the project it reached.
//
// The only lines specific to Linux are the registerWith calls below. Every
// other line is ordinary firebase_core and would compile unchanged on Android.
...
class _ExampleAppState extends State<_ExampleApp> {
  ...
  Future<String> _work() async {
    return 'initialized ${Firebase.app().options.projectId}';
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('firebase_core on Linux')),
        body: Center(
          child: Column(
